...
## Context platform implementation note

The current application retains Wareongo branding. Inter is self-hosted under the SIL Open Font License (OFL); `ui-monospace` substitutes for Berkeley Mono. This latest Linear reference supersedes the earlier Pravah reference for the active UI.
